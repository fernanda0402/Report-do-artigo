...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar  7 15:28:40 2024
...
data1 = np.genfromtxt('/home/usuario/Documentos/Códigos/Report do artigo/gamma_fs8_mc_novo.dat', delimiter='\t')
...
data2 = np.genfromtxt('/home/usuario/Documentos/Códigos/Report do artigo/gamma_fs8_mc_novo_Matern.dat', delimiter='\t')
...
#plt.savefig('gamma_CC_kernels_fs8.pdf', format='pdf', bbox_inches='tight')
plt.show()