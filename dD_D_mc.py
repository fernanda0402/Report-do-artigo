...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb  5 10:15:01 2024
...
Hz_data = np.genfromtxt('/home/usuario/Documentos/Códigos/Report do artigo/dh_recon.dat', delimiter='\t')
...
Ez_data = np.genfromtxt('/home/usuario/Documentos/Códigos/Report do artigo/E_recon.dat', delimiter='\t')
...
#np.savetxt('dD_recon.dat', np.transpose(G), delimiter='\t')
