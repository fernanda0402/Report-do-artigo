...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar  4 12:53:27 2024
...
plt.fill_between(xi, dm-edm, dm+edm, alpha=0.5, color='forestgreen', ec='None')
plt.fill_between(xi, dm-1.96*edm, dm+1.96*edm, alpha=0.5, color='lightgreen', ec='None')
#plt.legend(loc='best', fontsize=12)    
#plt.savefig('diff_mu_0_f8z.pdf', format='pdf', bbox_inches='tight')    