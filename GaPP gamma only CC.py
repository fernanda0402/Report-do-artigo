...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar  7 14:14:01 2024
...
# baixando os dados
data_Hz = np.genfromtxt('/home/usuario/Documentos/Códigos/Report do artigo/dh_recon.dat', delimiter='\t')
...
Dz = np.genfromtxt('/home/usuario/Documentos/Códigos/Report do artigo/dD_recon.dat', delimiter='\t')
...
fz = np.genfromtxt('/home/usuario/Documentos/Códigos/Report do artigo/dfs8_recon_novo.dat', delimiter='\t')
...
#np.savetxt('gamma_fs8_mc_novo.dat', np.transpose(G), delimiter='\t')
...
#plt.savefig('gamma_nofs8_mc_new.pdf', format='pdf', bbox_inches='tight')
plt.show()
