...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 30 14:09:42 2024
...
fz = np.genfromtxt('/home/usuario/Documentos/Códigos/Report do artigo/df_recon.dat', delimiter='\t')
...
#np.savetxt('gamma_mc_novo.dat', np.transpose(G), delimiter='\t')
...
#plt.savefig('gamma_mc.pdf', format='pdf', bbox_inches='tight')
plt.show()
