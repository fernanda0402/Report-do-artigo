...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar  7 14:35:24 2024
...
#plt.fill_between(z, y_pred - 1.96*sigma , y_pred + 1.96*sigma , alpha=.5, fc='lightgreen', ec='None')
...
#np.savetxt('dfs8_recon_novo_Matern.dat', np.transpose(G), delimiter='\t')
...
plt.legend(loc='best')
#plt.savefig('dfs8_fs8_mc_Matern.pdf', format='pdf', bbox_inches='tight')
plt.show()
